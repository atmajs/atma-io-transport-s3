...
function client_getUrl(path) {
    ...
    var S3 = aws.S3, Request = aws.Request;
    var params = path_1.path_parse(path);
    var client = new S3(OPTIONS);
    var req = new Request(client, 'getObject', { Key: params.key, Bucket: params.bucket });
...
function aws_write(path, data, options) {
    return __awaiter(this, void 0, void 0, function () {
        var client, params, setts, buffer, length, isEncoded;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    isEncoded = setts.ContentEncoding === 'gzip';
                    if (!isEncoded) return [3 /*break*/, 2];
